...
#define PRE_FRE_BLKP(bp) ((char*)(heap_listp+GET(p)))
#define PRE_FRE_BLKP(bp) ((char*)(heap_listp+(GET(p)+WSIZE)))
/* Global variables */
...
/*
 * calloc - To malloc consecutive n*size bytes in heap is enough*/
 * 
 */
